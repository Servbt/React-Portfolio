  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className='d-flex justify-content-center border-bottom border-2 border-dark custom-border-2'></div>
        ...
        <ul className='container pt-3 '>
          <div className='row d-flex'>
            ...
            <div className='card bg-transparent border-0 col' style={{ width: '18rem' }}>
              <div className='card-body text-center'>
                <svg xmlns='http://www.w3.org/2000/svg' width='50' height='50' fill='currentColor' class='bi bi-hexagon-half' viewBox='0 0 16 16'>
        ...
        <ul className='container pt-3'>
          <div className='row d-flex'>
            ...
            <div className='card bg-transparent border-0 col' style={{ width: '18rem' }}>
              <div className='card-body text-center'>
                <svg xmlns='http://www.w3.org/2000/svg' width='50' height='50' fill='currentColor' class='bi bi-window-split' viewBox='0 0 16 16'>
      ...
      <div>
        <div className='d-flex justify-content-center border-bottom border-2 border-dark custom-border-2'></div>
        <h1 className='text-center p-4 what-I-know'>Portfolio</h1>
