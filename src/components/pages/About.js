    ...
    <div className='container main-content-2 pt-5 '>
      ...
      <div className='ps-3'>
        ...
        <div className="diagonal-div row">
          ...
          <div className='col steam-cust'>
            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-steam" viewBox="0 0 16 16">
          ...
          <div className='col discord-cust'>
