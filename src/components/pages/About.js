  ...
  return (
    ...
    <div className='container main-content-2 pt-5 '>
      <div className='row ps-2'>
        <div className='col'>
          <h1 className='about-me-title pb-3'>About Me</h1>
          <div className='border-top border-3 border-dark custom-border-3 mb-3'></div>
          <p className='under-me-header about-me'>I'm currently a pharmacy tech at Publix Super Markets
      ...
      <div className='ps-3 '>
        ...
        <div className="diagonal-div row ">
          ...
          <a href='https://steamcommunity.com/profiles/76561198044842761/' target='_blank' rel="noreferrer" className='col steam-cust hvr-grow'>
            <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-steam" viewBox="0 0 16 16">
          ...
          <a href='https://discord.com/channels/127651474531549184' target='_blank' rel="noreferrer" className='col discord-cust hvr-grow'>
            <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-discord" viewBox="0 0 16 16">
