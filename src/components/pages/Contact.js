  ...
  return (
    <div className="main-content-2 container p-5 ">
      ...
      <div className='row'>
        ...
        <div className='resume col-md-6 right-column justify-content-center ps-5 pb-4'>
          <div className='d-flex resume-mobile'>
          ...
          <div className=" icon-container align-self-end text-center pt-5">
