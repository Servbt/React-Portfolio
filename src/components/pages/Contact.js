...
export const ContactUs = () => {
  ...
  return (
    <div className=" contact-body p-5 ">
      ...
      <div className='row'>
        <div className="col-md-6 custom-form-cont  mt-3">
          <div className='p-5 inside-form rounded-5'>
            ...
            <div id="liveAlertPlaceholder" className='popup'></div>
          </div>
        </div>
          ...
          <div className='resume-mobile justify-content-center link-bg'>
            <div className=' text-center resume-image p-3 rounded-5 link-bg'>
              <div className='resume'>
                <svg xmlns='http://www.w3.org/2000/svg' width='80' height='80' fill='currentColor' className='bi bi-file-earmark-arrow-down link-bg' viewBox='0 0 16 16'>
                  <path d='M8.5 6.5a.5.5 0 0 0-1 0v3.793L6.354 9.146a.5.5 0 1 0-.708.708l2 2a.5.5 0 0 0 .708 0l2-2a.5.5 0 0 0-.708-.708L8.5 10.293V6.5z' />
                  <path d='M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z' />
                </svg>
              </div>
              <div className='resume'>
                <h3 className='pt-3 link-bg'>
                  My Resume
                </h3>
              <p className='link-bg'>(It's a Google Drive link)</p>
              </div>
            </div>
          </div>
